...
import heroImage from "../../public/shophero.jpg";
  ...
  return (
    <div className="w-full h-[60vh] relative" {...storyblokEditable(blok)}>
      ...
      <div className="absolute w-2/3 h-[40vh] top-5 left-1/2 -translate-x-1/2">
        <h1 className="font-incon text-center tracking-widest text-[35px] text-white">
          Products
        </h1>
        ...
        <div>
          <Carousel showStatus={false} showThumbs={false}>
            {blok.product_page?.slice(0, 8).map((item, index) => (
              <div className="w-4/5 mx-auto h-[25vh] flex " key={index}>
                <img
